        ...
        <div class="list-group">
            <form method="get" action="../list">
                <div class="list-group-item list-group-item-action d-flex bg-secundary">
                    <a class="text-secondary" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="100%" fill="currentColor" class="bi bi-funnel-fill"
                            viewBox="0 0 16 16" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                            <path
